...
public class AdminEventService implements EventService {
    ...
    public List<EventFullDto> getAllEvents(List<Long> users,
        ...
        List<Event> eventList = eventRepository.getAllEvents(users, states, categories,
    ...
    public EventFullDto updateEvent(NewOrUpdateEventDto eventDto, Long eventId) {
        ...
        log.debug("\n\n\n!!!!\n\n\n{}\n\n\n!!!!\n\n\n", "Проблема не в мапере.");
        eventFullDto.setConfirmedRequests(confirmedRequests);
        log.debug("\n\n\n!!!!\n\n\n{}\n\n\n!!!!\n\n\n", "Проблема не в поле confirmedRequests.");
    ...
    private EventFullDto addViewsToEvent(EventFullDto eventFullDto) {
        ...
        log.debug("\n\n\n!!!!\n\n\n{}\n\n\n!!!!\n\n\n", 1);
        // получаем статистику просмотров:
        List<ViewStats> statsList = client.getStats(STATS_START, STATS_END, new ArrayList<>(List.of(eventUri)), false)/*.getBody()*/;
    ...
    private Event updateEventState(Event event, NewOrUpdateEventDto eventDto) {
        switch (EventStatusForAdmin.valueOf(eventDto.getStateAction())) {
