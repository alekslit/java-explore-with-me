...
import static ru.practicum.ewm.exception.conflict.AlreadyExistException.DUPLICATE_COMPILATION_NAME_ADVICE;
import static ru.practicum.ewm.exception.conflict.AlreadyExistException.DUPLICATE_COMPILATION_NAME_MESSAGE;
...
public class AdminCompilationService {
    ...
    public Compilation saveCompilation(NewCompilationDto compilationDto) {
        ...
        // сохраняем подборку:
        return saveCompilationObject(compilation);
    }
    ...
    public Compilation updateCompilation(UpdateCompilationRequest compilationRequest, Long compId) {
        ...
        // обновляем объект:
        updateCompilationObject(compilation, compilationRequest);
    ...
    private void updateCompilationObject(Compilation compilation, UpdateCompilationRequest compilationRequest) {
